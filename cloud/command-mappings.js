...
const COMMAND_MAPPINGS = {
  ...
  'волум на компьютере выше': { command: 'volume_up' },
  'сделай на пк волум выше': { command: 'volume_up' },
  'волум компьютера выше': { command: 'volume_up' },
  'волум на компьютере ниже': { command: 'volume_down' },
  'сделай на пк волум ниже': { command: 'volume_down' },
  'волум компьютера ниже': { command: 'volume_down' },
  ...
  'волум компьютера ноль': { command: 'volume_set', level: 0 },
  'волум на пк ноль': { command: 'volume_set', level: 0 },
  'волум компьютера десять': { command: 'volume_set', level: 10 },
  'волум на пк десять': { command: 'volume_set', level: 10 },
  'волум двадцать': { command: 'volume_set', level: 20 },
  'волум тридцать': { command: 'volume_set', level: 30 },
  'волум сорок': { command: 'volume_set', level: 40 },
  'волум пятьдесят': { command: 'volume_set', level: 50 },
  'волум шестьдесят': { command: 'volume_set', level: 60 },
  'волум семьдесят': { command: 'volume_set', level: 70 },
  'волум восемьдесят': { command: 'volume_set', level: 80 },
  'волум девяносто': { command: 'volume_set', level: 90 },
  'волум сто': { command: 'volume_set', level: 100 },
  'волум максимум': { command: 'volume_set', level: 100 },
