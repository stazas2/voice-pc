...
const COMMAND_MAPPINGS = {
  ...
  'выключи компьютер через минуту': { command: 'shutdown_delayed', delay: 60 },
  'выключи пк через минуту': { command: 'shutdown_delayed', delay: 60 },
  'выключи через пять минут': { command: 'shutdown_delayed', delay: 300 },
  'выключи через десять минут': { command: 'shutdown_delayed', delay: 600 },
  'выключи через полчаса': { command: 'shutdown_delayed', delay: 1800 },
  'выключи через час': { command: 'shutdown_delayed', delay: 3600 },
  'отмени выключение': { command: 'shutdown_cancel' },
  'отмени выключение компьютера': { command: 'shutdown_cancel' },
  'не выключай': { command: 'shutdown_cancel' },
  ...
  // Браузерные медиа (YouTube, Netflix и т.д.)
  'пауза видео': { command: 'chrome_media_pause' },
  'останови видео': { command: 'chrome_media_pause' },
  'стоп видео': { command: 'chrome_media_pause' },
  'пауза ютуб': { command: 'chrome_media_pause' },
  'останови ютуб': { command: 'chrome_media_pause' },
  'стоп ютуб': { command: 'chrome_media_pause' },
  'пауза фильм': { command: 'chrome_media_pause' },
  'останови фильм': { command: 'chrome_media_pause' },
  'стоп фильм': { command: 'chrome_media_pause' },
