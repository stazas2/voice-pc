...
const VOLUME_PATTERNS = [
  /громкость\s+(?:на\s+)?(?:компьютер[еа]?|пк)\s+(\d+)/i,
  /громкость\s+(?:компьютер[еа]?)\s+(\d+)/i,
  /громкость\s+(?:на\s+)?(?:компьютер[еа]?|пк)\s+([\w\s]+)/i,
  /громкость\s+(?:компьютер[еа]?)\s+([\w\s]+)/i,
  /звук\s+(?:на\s+)?(?:компьютер[еа]?|пк)\s+(\d+)/i,
  /звук\s+(\d+)/i,
  /звук\s+([\w\s]+)/i,
  /установи\s+громкость\s+(?:на\s+)?(?:комьютер[еа]?|пк)\s+(\d+)/i,
  /установи\s+громкость\s+(?:компьютер[еа]?)\s+(\d+)/i,
  /поставь\s+громкость\s+(?:на\s+)?(?:компьютер[еа]?|пк)\s+(\d+)/i,
  /поставь\s+громкость\s+(?:компьютер[еа]?)\s+(\d+)/i
];
