@echo off
title Voice PC + Alice - Cloudflare Permanent Tunnel
color 0A
echo ===============================================
echo   VOICE PC CONTROLLER - PERMANENT TUNNEL
echo   URL: https://voice-pc.stazas2.tk
echo ===============================================
echo.
...
echo.
echo ===============================================
echo SUCCESS! Permanent tunnel is running at:
echo https://voice-pc.stazas2.tk
echo.
echo API endpoint for Yandex Cloud Function:
echo https://voice-pc.stazas2.tk/command
echo.
echo Cloud function is already updated!
echo Just deploy cloud-function.js to Yandex Cloud.
echo ===============================================
echo.
echo DONE! Your Voice PC is now accessible via permanent URL.
echo No more URL changes needed!
echo.
pause